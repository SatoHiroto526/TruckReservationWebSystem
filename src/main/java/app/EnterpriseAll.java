...
public class EnterpriseAll extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(userOnSession != null) {
			...
			List<Enterprise> list = service.getEenterpriseAll();
			request.setAttribute("enterpriseList", list);
			
			RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/view/enterpriseAll.jsp");
